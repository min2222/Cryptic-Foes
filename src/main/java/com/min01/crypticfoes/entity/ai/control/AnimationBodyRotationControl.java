package com.min01.crypticfoes.entity.ai.control;
...
public class AnimationBodyRotationControl<T extends Mob & IAnimatable> extends BodyRotationControl 
{
	...
	{
		this.mob.yBodyRot = CrypticUtil.rotlerp(this.mob.yBodyRot, this.mob.yHeadRot, this.mob.maxBodyTurnY());
	}

	private void rotateHeadIfNecessary() 
	{
		this.mob.yHeadRot = CrypticUtil.rotlerp(this.mob.yHeadRot, this.mob.yBodyRot, this.mob.maxBodyTurnY());
	}
	...
	private void rotateHeadTowardsFront() 
	{
		...
		this.mob.yBodyRot = CrypticUtil.rotlerp(this.mob.yBodyRot, this.mob.yHeadRot, f1);
	}
